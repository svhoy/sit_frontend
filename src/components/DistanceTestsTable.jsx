...
export default function DistanceTestsTable({handleTestState}) {
  ...
  let deleteDistance = async(id) => {
    let {response, data} = await api('/api/tests/settings/' + id + '/', 'DELETE')
                    ...
                    <div className="shadow sm:overflow-hidden sm:rounded-md">
                        <div className="bg-gray-50 px-1 py-3 text-left sm:px-3">
                            ...
                            {(checkTest != null) ? (
                                ...
                                >
                                    Start Test 
                                    <span className='ml-2'><FontAwesomeIcon icon={faPlay} /></span>
                                </button>
                            ):(
                                <button
                                    type='button' 
