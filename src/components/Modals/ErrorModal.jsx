...
export default function ErrorModal({ onClose, show, header, content }) {
    ...
    return (
        ...
        >
            <div
                className="modal-content w-5/6 p-4 bg-white dark:bg-neutral-800 shadow sm:w-4/6 md:w-3/6 sm:overflow-hidden sm:rounded-lg"
                onClick={(e) => {
                    e.stopPropagation()
                }}
                aria-hidden="true"
